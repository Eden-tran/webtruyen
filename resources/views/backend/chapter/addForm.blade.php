            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('admin.chapter.postAdd', $mangaId) }}" id='chapterForm' method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="slChapterActive">
                                    ...
                                    <option value=1 {{ old('slChapterActive') == 1 ? 'selected' : false }}>không kích
                                        hoạt
                                    </option>
                                    <option value=2 {{ old('slChapterActive') == 2 ? 'selected' : false }}>kích hoạt
                                    </option>
                                </select>
                            ...
                            <input type="hidden" id='chapterId' name='chapterId' value="{{ old('chapterId') }}">
